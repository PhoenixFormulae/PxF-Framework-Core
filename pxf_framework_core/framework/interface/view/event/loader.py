...
class EventLoader:
    ...
    def __init__(self, frame: typing.Type[FrameABC]):
    ...
    def load_event(self, properties: Dict) -> EventABC | None:
        ...
        event_type: Optional[type[EventABC]] = self.__frame_type.event_types.find_type(properties['type'])
