...
from core.framework.interface.view.user_control.loader import UserControlLoader
...
def get_user_controls(package_path: MutableSequence[str]) -> List[Type[UserControlABC]]:
