...
from core.framework.interface.view.control.exceptions import IncompleteControlPropertiesException
...
from core.framework.interface.view.control.metaclasses import PROPERTY_ATTRIBUTE_LIST_NAME, REQUIRED_ATTRIBUTE_LIST_NAME
from core.framework.interface.view.event.loader import EventLoader
from core.framework.interface.view.interfaces import ViewABC
from core.framework.utils.zip import unpack_tuples
...
class ControlLoader:
    ...
    def __init__(self, frame: FrameABC, interface_set: InterfaceSetABC | None, view: ViewABC | None = None):
        self.__frame: FrameABC = frame
        self.__interface_set: InterfaceSetABC | None = interface_set
        self.__view: ViewABC | None = view
    ...
    def __load_children(self, control: ControlABC, children: dict):
        for key, child_properties in children.items():
            ...
            if control_type:
                ...
                user_control = user_control_type
                child = self.load_user_control_instance(user_control, child_properties)
